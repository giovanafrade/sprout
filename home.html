...
<body>
  ...
  <button id="toggleBtn"><img src="Icones_de_Navegacao/SetaVoltar.png.png"></button>
    ...
    <div class="conteudoLateral" id="conteudoLateral">
      ...
      <nav class="menu-lateral">
        <ul>
          ...
          <li class="item-menu">
            <img src="Icones_de_Navegacao/Grupos.png.png" id="pagina_grupos" data-alvo="main_grupos"
              class="Paginas_Storage">
